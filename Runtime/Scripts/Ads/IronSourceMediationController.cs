...
public class IronSourceMediationController : AdsMediationController
{
   ...
   public override void Init()
   {
      if (IsInited) return;
      base.Init();
      SDKDebugLogger.Log("IronSource: MyAppStart Start called");

      string id = IronSource.Agent.getAdvertiserId();
      SDKDebugLogger.Log("IronSource: IronSource.Agent.getAdvertiserId : " + id);
      SDKDebugLogger.Log("IronSource: unity version" + IronSource.unityVersion());

      // SDK init
      SDKDebugLogger.Log("IronSource: IronSource.Agent.init");
      ...
      {
         SDKDebugLogger.Log("IronSource: onSdkInitializationCompletedEvent");
   ...
   private void IronSourceEvents_onImpressionSuccessEvent(IronSourceImpressionData impressionData)
   {
      ...
      {
         SDKDebugLogger.Log("ImpressionData: " + impressionData.ToString());
      ...
      Action adLoadFailedCallback, Action adShowSuccessCallback, Action adShowFailCallback)
   {
      base.InitInterstitialAd(adClosedCallback, adLoadSuccessCallback, adLoadFailedCallback, adShowSuccessCallback,
         adShowFailCallback);
      SDKDebugLogger.Log("Init IronSource Interstitial");
   ...
   {
      SDKDebugLogger.Log("Create InterstitialAd");
      ...
      SDKDebugLogger.Log("Create InterstitialAd Done");
   }
   ...
   public override void RequestInterstitialAd()
   {
      ...
      SDKDebugLogger.Log("Request IronSource Interstitial");
#if IRONSOURCE_LEGACY
   ...
   public override void ShowInterstitialAd()
   {
      ...
      SDKDebugLogger.Log("Show Iron source interstitial");
#if IRONSOURCE_LEGACY
      ...
      Action videoLoadFailed, Action videoStart)
   {
      ...
      SDKDebugLogger.Log("Init IronSource video");
   ...
   {
      SDKDebugLogger.Log("IronSource: I got RewardedVideoAdClickedEvent, name = " + placement.getRewardName());
   }

   private void RewardedVideoOnAdRewardedEvent(IronSourcePlacement placement, IronSourceAdInfo adInfo)
   {
      SDKDebugLogger.Log("IronSource: I got RewardedVideoAdRewardedEvent, name = " + placement.getRewardName());
   ...
   {
      SDKDebugLogger.Log("IronSource: I got RewardedVideoAdShowFailedEvent, code :  " + error.getCode() + ", description : " +
   ...
   {
      SDKDebugLogger.Log("IronSource: RewardedVideoAd Iron Loaded Fail");
      m_RewardedVideoLoadFailedCallback?.Invoke();
   }

   private void RewardedVideoOnAdAvailable(IronSourceAdInfo adInfo)
   {
      SDKDebugLogger.Log("IronSource: RewardedVideoAds Available");
      m_RewardedVideoLoadSuccessCallback?.Invoke();
   }

   private void RewardedVideoOnAdClosedEvent(IronSourceAdInfo adInfo)
   {
      SDKDebugLogger.Log("IronSource: I got RewardedVideoAdClosedEvent");
      if (m_RewardedVideoEarnSuccessCallback != null && m_IsWatchSuccess)
      {
         SDKDebugLogger.Log("Do Callback Success");
         EventManager.AddEventNextFrame(m_RewardedVideoEarnSuccessCallback);
         m_RewardedVideoEarnSuccessCallback = null;
      }
      else
      {
         SDKDebugLogger.Log("Don't have any callback");
      }
   ...
   {
      SDKDebugLogger.Log("IronSource: I got RewardedVideoAdOpenedEvent");
   }

   public override void RequestRewardVideoAd()
   {
      base.RequestRewardVideoAd();
      SDKDebugLogger.Log("Request ironsource Video");
   }
   ...
   public override void InitBannerAds(
      ...
      Action bannerAdsCollapsed,
      Action bannerAdsExpandedCallback,
      Action bannerAdsDisplayed = null,
      Action bannerAdsDisplayedFailedCallback = null,
      Action bannerAdsClickedCallback = null)
   {
      ...
      SDKDebugLogger.Log("IronSource: Init Banner");
   ...
   {
      SDKDebugLogger.Log("IronSource: I got BannerAdLoadedEvent");
      isBannerLoaded = true;
   ...
   {
      SDKDebugLogger.Log("IronSource: I got BannerAdLoadFailedEvent " + error.ErrorMessage);
   ...
   {
      SDKDebugLogger.Log("IronSource: I got BannerAdDisplayedEvent");
   ...
   {
      SDKDebugLogger.Log("IronSource: I got BannerAdLoadFailedEvent " + adError.getDescription() + " code : " +
   ...
   public override void RequestBannerAds()
   {
      ...
      SDKDebugLogger.Log("IronSource: Request IronSource Banner");
      isBannerLoaded = false;
#if IRONSOURCE_LEGACY
   ...
   {
      base.ShowBannerAds();
      SDKDebugLogger.Log("IronSource: Show IronSource Banner");
#if IRONSOURCE_LEGACY
